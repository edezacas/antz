...
- `sh tests/run_all.sh` stays hermetic and under 60s. `tests/hygiene_test.sh` enforces these rules. A red run means a real regression or a law violation — nothing else.
