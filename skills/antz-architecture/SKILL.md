...
Comment only what the code cannot say: why it is written this way, or the business decision behind it. A comment that describes what the code does is noise; names, structure and tests already say it.
